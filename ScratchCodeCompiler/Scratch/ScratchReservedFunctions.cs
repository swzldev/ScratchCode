...
namespace ScratchCodeCompiler.Scratch
{
    internal static class ScratchReservedFunctions
    {
        ...
        [
            ...
            new("ChangeEffectBy", ["EFFECT", "CHANGE"], ScratchOpcode.Looks_ChangeEffectBy),
            new("SetEffectTo", ["EFFECT", "VALUE"], ScratchOpcode.Looks_SetEffectTo),
            ...
            new("ChangeEffectBy", ["EFFECT", "VALUE"], ScratchOpcode.Sound_ChangeEffectBy),
            new("SetEffectTo", ["EFFECT", "VALUE"], ScratchOpcode.Sound_SetEffectTo),
